...
import 'package:onboarding/src/ui/intro_button.dart';
import 'package:onboarding/src/ui/intro_page.dart';
...
class IntroductionScreen extends StatefulWidget {
  ...
  /// Callback when foucsed on last page
...
class IntroductionScreenState extends State<IntroductionScreen> {
  ...
  void initState() {
    ...
    if (_currentPage.round() == getPagesLength() - 1) {
      widget.onLastPage!();
    }
  }
